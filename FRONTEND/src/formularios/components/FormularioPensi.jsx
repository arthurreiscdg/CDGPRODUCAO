...
import { enviarFormularioPensi } from '../services/apiService';

export default function FormularioPensi() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await enviarFormularioPensi(formData);
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">Formulário Pensi</h2>
