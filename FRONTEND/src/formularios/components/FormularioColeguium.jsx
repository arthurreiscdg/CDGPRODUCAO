...
import { enviarFormularioColeguium } from '../services/apiService';

export default function FormularioColeguium() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await enviarFormularioColeguium(formData);
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">Formulário Coleguium</h2>
